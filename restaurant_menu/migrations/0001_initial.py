    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name_en",
                    models.CharField(
                        blank=True, max_length=255, null=True, unique=True, verbose_name="Название на английском"
                    ),
                ),
                (
                    "name_ch",
                    models.CharField(
                        blank=True, max_length=255, null=True, unique=True, verbose_name="Название на китайском"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "internal_code",
                    models.IntegerField(blank=True, null=True, unique=True, verbose_name="Код в приложении"),
                ),
                ("name_ru", models.CharField(max_length=255, verbose_name="Название на русском")),
                (
                    "description_ru",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="Описание на русском"),
                ),
                (
                    "description_en",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="Описание на английском"),
                ),
                (
                    "description_ch",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="Описание на китайском"),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="food",
                        to="restaurant_menu.foodcategory",
                        verbose_name="Раздел меню",
                    ),
                ),
            ],
